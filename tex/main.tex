...
\lstset{extendedchars=false,showspaces=false}
...
\img{strings-fileeditor}{Okno edytora plików}{7cm}
...
\img{strings-nrlinii}{Prawy dolny róg okna edytora powie ci w której linii znajduje się kursor. Tutaj znajduje się w linii 12.}{3cm}
